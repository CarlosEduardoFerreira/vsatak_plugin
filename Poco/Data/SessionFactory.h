...
public:
	...
	Session create(const std::string& key,
		...
		/// Creates a Session for the given key with the connectionString. Throws an include.Poco.Poco.Poco:Data::UnknownDataBaseException
	...
	Session create(const std::string& uri,
		...
		/// Throws a include.Poco.Poco.Poco:Data::UnknownDataBaseException if no Connector is registered for the key.
