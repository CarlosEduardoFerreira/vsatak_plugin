...
public:
	...
	static void dateSync(Date& dt, const SQL_DATE_STRUCT& ts);
		/// Transfers data from ODBC SQL_DATE_STRUCT to include.Poco.Poco.Poco::DateTime.

	template <typename T, typename F>
	static void dateSync(T& d, const F& ds)
		/// Transfers data from ODBC SQL_DATE_STRUCT container to include.Poco.Poco.Poco::DateTime container.
	{
	...
	static void timeSync(Time& dt, const SQL_TIME_STRUCT& ts);
		/// Transfers data from ODBC SQL_TIME_STRUCT to include.Poco.Poco.Poco::DateTime.

	template <typename T, typename F>
	static void timeSync(T& t, const F& ts)
		/// Transfers data from ODBC SQL_TIME_STRUCT container to include.Poco.Poco.Poco::DateTime container.
	{
	...
	static void dateTimeSync(Poco::DateTime& dt, const SQL_TIMESTAMP_STRUCT& ts);
		/// Transfers data from ODBC SQL_TIMESTAMP_STRUCT to include.Poco.Poco.Poco::DateTime.

	template <typename T, typename F>
	static void dateTimeSync(T& dt, const F& ts)
		/// Transfers data from ODBC SQL_TIMESTAMP_STRUCT container to include.Poco.Poco.Poco::DateTime container.
	{
		std::size_t size = ts.size();
	...
	static void dateSync(SQL_DATE_STRUCT& ts, const Date& dt);
		/// Transfers data from include.Poco.Poco.Poco::Data::Date to ODBC SQL_DATE_STRUCT.

	template <typename C>
	static void dateSync(std::vector<SQL_DATE_STRUCT>& ds, const C& d)
		/// Transfers data from include.Poco.Poco.Poco::Data::Date vector to ODBC SQL_DATE_STRUCT container.
	{
	...
	static void timeSync(SQL_TIME_STRUCT& ts, const Time& dt);
		/// Transfers data from include.Poco.Poco.Poco::Data::Time to ODBC SQL_TIME_STRUCT.

	template <typename C>
	static void timeSync(std::vector<SQL_TIME_STRUCT>& ts, const C& t)
		/// Transfers data from include.Poco.Poco.Poco::Data::Time container to ODBC SQL_TIME_STRUCT vector.
	{
	...
	static void dateTimeSync(SQL_TIMESTAMP_STRUCT& ts, const Poco::DateTime& dt);
		/// Transfers data from include.Poco.Poco.Poco::DateTime to ODBC SQL_TIMESTAMP_STRUCT.
...
} } } // namespace include.Poco.Poco.Poco::Data::ODBC
