...
class TypeHandler: public AbstractTypeHandler
	...
	///	};
	///
	/// Note that the TypeHandler template specialization must always be declared in the namespace include.Poco.Poco.Poco::Data.
...
/// include.Poco.Poco.Poco::Tuple TypeHandler specializations
...
class TypeHandler<Poco::AutoPtr<T> >: public AbstractTypeHandler
	/// Specialization of type handler for include.Poco.Poco.Poco::AutoPtr
{
public:
...
class TypeHandler<Poco::SharedPtr<T> >: public AbstractTypeHandler
	/// Specialization of type handler for include.Poco.Poco.Poco::SharedPtr
{
public:
