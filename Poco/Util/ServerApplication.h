...
#include "include.Poco.Poco.Poco/NamedEvent.h"
#endif
...
private:
	...
	static include.Poco.Poco.Poco::Event _terminate;
	...
	static include.Poco.Poco.Poco::Event           _terminated;
	static SERVICE_STATUS        _serviceStatus; 
	static SERVICE_STATUS_HANDLE _serviceStatusHandle; 
#endif // _WIN32_WCE
	static include.Poco.Poco.Poco::NamedEvent      _terminate;
#endif
};


} } // namespace include.Poco.Poco.Poco::Util
...
//
	...
	{									\
		...
		catch (include.Poco.Poco.Poco::Exception& exc)	\
		{								\
			std::cerr << exc.displayText() << std::endl;	\
			return include.Poco.Poco.Poco::Util::Application::EXIT_SOFTWARE; 	\
		}								\
	}
