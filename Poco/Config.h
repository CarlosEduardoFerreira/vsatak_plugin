...
// platforms (returned by include.Poco.Poco.Poco::Thread::getMinOSPriority()).
// #define POCO_THREAD_PRIORITY_MIN 0


// Define to override system-provided
// maximum thread priority value on POSIX
// platforms (returned by include.Poco.Poco.Poco::Thread::getMaxOSPriority()).
...
// OpenSSL on Windows
//
// include.Poco.Poco.Poco has its own OpenSSL build system.
// See <https://github.com/pocoproject/openssl/blob/master/README.md>
// for details.
//
// These options are Windows only.
//
// To disable the use of include.Poco.Poco.Poco-provided OpenSSL binaries,
...
// to "d.so", "d.dll", etc. for _DEBUG builds in include.Poco.Poco.Poco::SharedLibrary.
