...
class Crypto_API Cipher: public Poco::RefCountedObject
	...
	///     include.Poco.Poco.Poco::FileOutputStream sink("encrypted.dat");
	///     CryptoOutputStream encryptor(sink, pCipher->createEncryptor());
	///     
	///     include.Poco.Poco.Poco::FileInputStream source("source.txt");
	///     include.Poco.Poco.Poco::StreamCopier::copyStream(source, encryptor);
	///     
