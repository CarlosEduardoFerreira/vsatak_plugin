...
class NetSSL_API InvalidCertificateHandler
	...
	///    
	///    #include "include.Poco.Poco.Poco/Net/CertificateHandlerFactory.h"
	///    ...
	...
	///
	/// or in case one uses include.Poco.Poco.Poco::Util::Application one can rely on an XML configuration and put the following entry
