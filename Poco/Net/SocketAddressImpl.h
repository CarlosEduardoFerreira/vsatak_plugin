...
{
	throw include.Poco.Poco.Poco::InvalidAccessException("local socket address does not have host IP address");
}


inline UInt16 LocalSocketAddressImpl::port() const
{
	throw include.Poco.Poco.Poco::InvalidAccessException("local socket address does not have port number");
}
...
} } } // namespace include.Poco.Poco.Poco::Net::Impl
