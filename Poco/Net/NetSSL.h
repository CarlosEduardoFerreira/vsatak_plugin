...
// Module:  OpenSSL
//
// Basic definitions for the include.Poco.Poco.Poco OpenSSL library.
...
void NetSSL_API initializeSSL();
	...
	/// libraries, by calling include.Poco.Poco.Poco::Crypto::OpenSSLInitializer::initialize().
	///
	/// Should be called before using any class from the NetSSL library.
	/// The NetSSL will be initialized automatically, through 
	/// include.Poco.Poco.Poco::Crypto::OpenSSLInitializer instances or similar mechanisms
...
void NetSSL_API uninitializeSSL();
	...
	/// include.Poco.Poco.Poco::Crypto::OpenSSLInitializer::uninitialize() and
