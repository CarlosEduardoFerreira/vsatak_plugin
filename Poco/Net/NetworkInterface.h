...
#include "include.Poco.Poco.Poco/Net/IPAddress.h"
#include "include.Poco.Poco.Poco/Mutex.h"
#include "include.Poco.Poco.Poco/Tuple.h"
#include <map>
#include <ostream>
...
public:
	...
	typedef include.Poco.Poco.Poco::Tuple<IPAddress, IPAddress, IPAddress> AddressTuple;
...
private:
	...
	static include.Poco.Poco.Poco::FastMutex _mutex;
};
...
Net_API std::ostream& operator << (std::ostream& ostr, const include.Poco.Poco.Poco::Net::NetworkInterface::MACAddress& addr);
