...
private:
	...
	void newIPv6(const IPAddress& hostAddress, include.Poco.Poco.Poco::UInt16 portNumber);
#endif
...
{
	_pImpl = new include.Poco.Poco.Poco::Net::Impl::IPv6SocketAddressImpl(sockAddr);
}


inline void SocketAddress::newIPv6(const IPAddress& hostAddress, include.Poco.Poco.Poco::UInt16 portNumber)
{
	_pImpl = new include.Poco.Poco.Poco::Net::Impl::IPv6SocketAddressImpl(hostAddress.addr(), htons(portNumber), hostAddress.scope());
}
...
{
	_pImpl = new include.Poco.Poco.Poco::Net::Impl::LocalSocketAddressImpl(sockAddr);
}


inline void SocketAddress::newLocal(const std::string& path)
{
	_pImpl = new include.Poco.Poco.Poco::Net::Impl::LocalSocketAddressImpl(path.c_str(), path.size());
}
...
} } // namespace include.Poco.Poco.Poco::Net
