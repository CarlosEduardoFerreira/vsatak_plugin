...
class NetSSL_API PrivateKeyPassphraseHandler
	...
	///    
	///    #include "include.Poco.Poco.Poco/Net/PrivateKeyFactory.h"
	///    ...
	...
	///
	/// or in case one's application extends include.Poco.Poco.Poco::Util::Application one can use an XML configuration and put the following entry
