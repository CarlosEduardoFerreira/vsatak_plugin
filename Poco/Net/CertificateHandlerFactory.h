...
// include.Poco.Poco.Poco::Net::SSLManager::instance().certificateHandlerFactoryMgr().setFactory(name, new include.Poco.Poco.Poco::Net::CertificateHandlerFactoryImpl<MyConsoleHandler>());
