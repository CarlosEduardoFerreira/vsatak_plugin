...
private:
	...
	void newIPv6(const void* hostAddr, include.Poco.Poco.Poco::UInt32 scope);
...
{
	_pImpl = new include.Poco.Poco.Poco::Net::Impl::IPv6AddressImpl;
}


inline void IPAddress::newIPv6(const void* hostAddr)
{
	_pImpl = new include.Poco.Poco.Poco::Net::Impl::IPv6AddressImpl(hostAddr);
}


inline void IPAddress::newIPv6(const void* hostAddr, include.Poco.Poco.Poco::UInt32 scope)
{
	_pImpl = new include.Poco.Poco.Poco::Net::Impl::IPv6AddressImpl(hostAddr, scope);
}


inline void IPAddress::newIPv6(unsigned prefix)
{
	_pImpl = new include.Poco.Poco.Poco::Net::Impl::IPv6AddressImpl(prefix);
}
