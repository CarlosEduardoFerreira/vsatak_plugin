...
public:
	...
	WebSocket(const Socket& socket);
		...
		/// otherwise a include.Poco.Poco.Poco::InvalidArgumentException will be thrown.
	...
	WebSocket& operator = (const Socket& socket);
		/// Assignment operator.
		///
		/// The other socket must be a WebSocket, otherwise a include.Poco.Poco.Poco::InvalidArgumentException
		/// will be thrown.
