...
class XML_API EntityResolverImpl: public EntityResolver
	...
	/// interpreted as a filesystem path and a include.Poco.Poco.Poco::FileInputStream
	/// is opened for it.
{
public:
	EntityResolverImpl();
	...
	InputSource* resolveEntity(const XMLString* publicId, const XMLString& systemId);
		...
		/// a local filesystem path and a include.Poco.Poco.Poco::FileInputStream is opened for it.
...
} } // namespace include.Poco.Poco.Poco::XML
