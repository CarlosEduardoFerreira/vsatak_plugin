...
class JSON_API Array
	...
	/// convert Array to include.Poco.Poco.Poco::Dynamic::Array. Conversion requires copying and therefore
	/// has performance penalty; the benefit is in improved syntax, eg:
	///
	///    // use pointers to avoid copying
	///    using namespace include.Poco.Poco.Poco::JSON;
	...
	///
	///    // copy/convert to include.Poco.Poco.Poco::Dynamic::Array
	///    include.Poco.Poco.Poco::Dynamic::Array da = *arr;
	///    i = da[0]["test"];     // i == 0
	///    i = da[1]["test1"][1]; // i == 2
	///    i = da[1]["test2"];    // i == 4
	/// ----
...
} } // namespace include.Poco.Poco.Poco::JSON
