...
class JSON_API Object
	...
	///
	///    // copy/convert to include.Poco.Poco.Poco::DynamicStruct
	///    include.Poco.Poco.Poco::DynamicStruct ds = *object;
...
public:
	...
	operator const Poco::DynamicStruct& () const;
		/// Cast operator to include.Poco.Poco.Poco::DynamiStruct.
