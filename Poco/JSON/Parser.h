...
class JSON_API Parser: private ParserImpl
	...
	/// or an Array. Therefore the result of parse() is a include.Poco.Poco.Poco::Dynamic::Var
	/// containing a include.Poco.Poco.Poco::SharedPtr to an Object or Array instance.
	///
	/// Example:
	/// 
	///    std::string json = "{ \"name\" : \"Franky\", \"children\" : [ \"Jonas\", \"Ellen\" ] }";
