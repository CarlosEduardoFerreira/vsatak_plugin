...
union Placeholder
	/// ValueHolder union (used by include.Poco.Poco.Poco::Any and include.Poco.Poco.Poco::Dynamic::Var for small
...
class Any
	...
	///
	/// Code taken from the Boost 1.33.1 library. Original copyright by Kevlin Henney. Modified for include.Poco.Poco.Poco
