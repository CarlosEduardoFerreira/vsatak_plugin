...
class AbstractEvent
	...
	///
	///     #include "include.Poco.Poco.Poco/BasicEvent.h"
	///     #include "include.Poco.Poco.Poco/Delegate.h"
	///
	...
	///
	///     #include "include.Poco.Poco.Poco/PriorityEvent.h"
	///     #include "include.Poco.Poco.Poco/PriorityDelegate.h"
	///
	...
	///     {
	///     public:
	///         include.Poco.Poco.Poco::BasicEvent<int> dataChanged;
	///
	///         MyData();
	///         ...
	///         void setData(int i);
