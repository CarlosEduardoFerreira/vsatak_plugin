...
inline Poco::Int8 operator + (const Poco::Int8& other, const Var& da)
	/// Addition operator for adding Var to include.Poco.Poco.Poco::Int8
{
...
inline Poco::Int8 operator - (const Poco::Int8& other, const Var& da)
	/// Subtraction operator for subtracting Var from include.Poco.Poco.Poco::Int8
{
	return other - da.convert<Poco::Int8>();
}
...
inline Poco::Int8 operator * (const Poco::Int8& other, const Var& da)
	/// Multiplication operator for multiplying Var with include.Poco.Poco.Poco::Int8
{
	return other * da.convert<Poco::Int8>();
}
...
inline Poco::Int8 operator / (const Poco::Int8& other, const Var& da)
	/// Division operator for dividing Var with include.Poco.Poco.Poco::Int8
{
	return other / da.convert<Poco::Int8>();
}
...
inline Poco::Int8 operator += (Poco::Int8& other, const Var& da)
	/// Addition assignment operator for adding Var to include.Poco.Poco.Poco::Int8
{
	return other += da.convert<Poco::Int8>();
}
...
inline Poco::Int8 operator -= (Poco::Int8& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from include.Poco.Poco.Poco::Int8
{
	return other -= da.convert<Poco::Int8>();
}
...
inline Poco::Int8 operator *= (Poco::Int8& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with include.Poco.Poco.Poco::Int8
{
	return other *= da.convert<Poco::Int8>();
}
...
inline Poco::Int8 operator /= (Poco::Int8& other, const Var& da)
	/// Division assignment operator for dividing Var with include.Poco.Poco.Poco::Int8
{
	return other /= da.convert<Poco::Int8>();
}
...
inline bool operator == (const Poco::Int8& other, const Var& da)
	/// Equality operator for comparing Var with include.Poco.Poco.Poco::Int8
{
	if (da.isEmpty()) return false;
	return other == da.convert<Poco::Int8>();
}
...
inline bool operator != (const Poco::Int8& other, const Var& da)
	/// Inequality operator for comparing Var with include.Poco.Poco.Poco::Int8
{
	if (da.isEmpty()) return true;
	return other != da.convert<Poco::Int8>();
}
...
inline bool operator < (const Poco::Int8& other, const Var& da)
	/// Less than operator for comparing Var with include.Poco.Poco.Poco::Int8
{
	if (da.isEmpty()) return false;
	return other < da.convert<Poco::Int8>();
}
...
inline bool operator <= (const Poco::Int8& other, const Var& da)
	/// Less than or equal operator for comparing Var with include.Poco.Poco.Poco::Int8
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Poco::Int8>();
}
...
inline bool operator > (const Poco::Int8& other, const Var& da)
	/// Greater than operator for comparing Var with include.Poco.Poco.Poco::Int8
{
	if (da.isEmpty()) return false;
	return other > da.convert<Poco::Int8>();
}
...
inline bool operator >= (const Poco::Int8& other, const Var& da)
	/// Greater than or equal operator for comparing Var with include.Poco.Poco.Poco::Int8
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Poco::Int8>();
}
...
inline Poco::UInt8 operator + (const Poco::UInt8& other, const Var& da)
	/// Addition operator for adding Var to include.Poco.Poco.Poco::UInt8
{
...
inline Poco::UInt8 operator - (const Poco::UInt8& other, const Var& da)
	/// Subtraction operator for subtracting Var from include.Poco.Poco.Poco::UInt8
{
	return other - da.convert<Poco::UInt8>();
}
...
inline Poco::UInt8 operator * (const Poco::UInt8& other, const Var& da)
	/// Multiplication operator for multiplying Var with include.Poco.Poco.Poco::UInt8
{
	return other * da.convert<Poco::UInt8>();
}
...
inline Poco::UInt8 operator / (const Poco::UInt8& other, const Var& da)
	/// Division operator for dividing Var with include.Poco.Poco.Poco::UInt8
{
	return other / da.convert<Poco::UInt8>();
}
...
inline Poco::UInt8 operator += (Poco::UInt8& other, const Var& da)
	/// Addition assignment operator for adding Var to include.Poco.Poco.Poco::UInt8
{
	return other += da.convert<Poco::UInt8>();
}
...
inline Poco::UInt8 operator -= (Poco::UInt8& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from include.Poco.Poco.Poco::UInt8
{
	return other -= da.convert<Poco::UInt8>();
}
...
inline Poco::UInt8 operator *= (Poco::UInt8& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with include.Poco.Poco.Poco::UInt8
{
	return other *= da.convert<Poco::UInt8>();
}
...
inline Poco::UInt8 operator /= (Poco::UInt8& other, const Var& da)
	/// Division assignment operator for dividing Var with include.Poco.Poco.Poco::UInt8
{
	return other /= da.convert<Poco::UInt8>();
}
...
inline bool operator == (const Poco::UInt8& other, const Var& da)
	/// Equality operator for comparing Var with include.Poco.Poco.Poco::UInt8
{
	if (da.isEmpty()) return false;
	return other == da.convert<Poco::UInt8>();
}
...
inline bool operator != (const Poco::UInt8& other, const Var& da)
	/// Inequality operator for comparing Var with include.Poco.Poco.Poco::UInt8
{
	if (da.isEmpty()) return true;
	return other != da.convert<Poco::UInt8>();
}
...
inline bool operator < (const Poco::UInt8& other, const Var& da)
	/// Less than operator for comparing Var with include.Poco.Poco.Poco::UInt8
{
	if (da.isEmpty()) return false;
	return other < da.convert<Poco::UInt8>();
}
...
inline bool operator <= (const Poco::UInt8& other, const Var& da)
	/// Less than or equal operator for comparing Var with include.Poco.Poco.Poco::UInt8
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Poco::UInt8>();
}
...
inline bool operator > (const Poco::UInt8& other, const Var& da)
	/// Greater than operator for comparing Var with include.Poco.Poco.Poco::UInt8
{
	if (da.isEmpty()) return false;
	return other > da.convert<Poco::UInt8>();
}
...
inline bool operator >= (const Poco::UInt8& other, const Var& da)
	/// Greater than or equal operator for comparing Var with include.Poco.Poco.Poco::UInt8
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Poco::UInt8>();
}
...
inline Poco::Int16 operator + (const Poco::Int16& other, const Var& da)
	/// Addition operator for adding Var to include.Poco.Poco.Poco::Int16
{
...
inline Poco::Int16 operator - (const Poco::Int16& other, const Var& da)
	/// Subtraction operator for subtracting Var from include.Poco.Poco.Poco::Int16
{
	return other - da.convert<Poco::Int16>();
}
...
inline Poco::Int16 operator * (const Poco::Int16& other, const Var& da)
	/// Multiplication operator for multiplying Var with include.Poco.Poco.Poco::Int16
{
	return other * da.convert<Poco::Int16>();
}
...
inline Poco::Int16 operator / (const Poco::Int16& other, const Var& da)
	/// Division operator for dividing Var with include.Poco.Poco.Poco::Int16
{
	return other / da.convert<Poco::Int16>();
}
...
inline Poco::Int16 operator += (Poco::Int16& other, const Var& da)
	/// Addition assignment operator for adding Var to include.Poco.Poco.Poco::Int16
{
	return other += da.convert<Poco::Int16>();
}
...
inline Poco::Int16 operator -= (Poco::Int16& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from include.Poco.Poco.Poco::Int16
{
	return other -= da.convert<Poco::Int16>();
}
...
inline Poco::Int16 operator *= (Poco::Int16& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with include.Poco.Poco.Poco::Int16
{
	return other *= da.convert<Poco::Int16>();
}
...
inline Poco::Int16 operator /= (Poco::Int16& other, const Var& da)
	/// Division assignment operator for dividing Var with include.Poco.Poco.Poco::Int16
{
	return other /= da.convert<Poco::Int16>();
}
...
inline bool operator == (const Poco::Int16& other, const Var& da)
	/// Equality operator for comparing Var with include.Poco.Poco.Poco::Int16
{
	if (da.isEmpty()) return false;
	return other == da.convert<Poco::Int16>();
}
...
inline bool operator != (const Poco::Int16& other, const Var& da)
	/// Inequality operator for comparing Var with include.Poco.Poco.Poco::Int16
{
	if (da.isEmpty()) return true;
	return other != da.convert<Poco::Int16>();
}
...
inline bool operator < (const Poco::Int16& other, const Var& da)
	/// Less than operator for comparing Var with include.Poco.Poco.Poco::Int16
{
	if (da.isEmpty()) return false;
	return other < da.convert<Poco::Int16>();
}
...
inline bool operator <= (const Poco::Int16& other, const Var& da)
	/// Less than or equal operator for comparing Var with include.Poco.Poco.Poco::Int16
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Poco::Int16>();
}
...
inline bool operator > (const Poco::Int16& other, const Var& da)
	/// Greater than operator for comparing Var with include.Poco.Poco.Poco::Int16
{
	if (da.isEmpty()) return false;
	return other > da.convert<Poco::Int16>();
}
...
inline bool operator >= (const Poco::Int16& other, const Var& da)
	/// Greater than or equal operator for comparing Var with include.Poco.Poco.Poco::Int16
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Poco::Int16>();
}
...
inline Poco::UInt16 operator + (const Poco::UInt16& other, const Var& da)
	/// Addition operator for adding Var to include.Poco.Poco.Poco::UInt16
{
...
inline Poco::UInt16 operator - (const Poco::UInt16& other, const Var& da)
	/// Subtraction operator for subtracting Var from include.Poco.Poco.Poco::UInt16
{
	return other - da.convert<Poco::UInt16>();
}
...
inline Poco::UInt16 operator * (const Poco::UInt16& other, const Var& da)
	/// Multiplication operator for multiplying Var with include.Poco.Poco.Poco::UInt16
{
	return other * da.convert<Poco::UInt16>();
}
...
inline Poco::UInt16 operator / (const Poco::UInt16& other, const Var& da)
	/// Division operator for dividing Var with include.Poco.Poco.Poco::UInt16
{
	return other / da.convert<Poco::UInt16>();
}
...
inline Poco::UInt16 operator += (Poco::UInt16& other, const Var& da)
	/// Addition assignment operator for adding Var to include.Poco.Poco.Poco::UInt16
{
	return other += da.convert<Poco::UInt16>();
}
...
inline Poco::UInt16 operator -= (Poco::UInt16& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from include.Poco.Poco.Poco::UInt16
{
	return other -= da.convert<Poco::UInt16>();
}
...
inline Poco::UInt16 operator *= (Poco::UInt16& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with include.Poco.Poco.Poco::UInt16
{
	return other *= da.convert<Poco::UInt16>();
}
...
inline Poco::UInt16 operator /= (Poco::UInt16& other, const Var& da)
	/// Division assignment operator for dividing Var with include.Poco.Poco.Poco::UInt16
{
	return other /= da.convert<Poco::UInt16>();
}
...
inline bool operator == (const Poco::UInt16& other, const Var& da)
	/// Equality operator for comparing Var with include.Poco.Poco.Poco::UInt16
{
	if (da.isEmpty()) return false;
	return other == da.convert<Poco::UInt16>();
}
...
inline bool operator != (const Poco::UInt16& other, const Var& da)
	/// Inequality operator for comparing Var with include.Poco.Poco.Poco::UInt16
{
	if (da.isEmpty()) return true;
	return other != da.convert<Poco::UInt16>();
}
...
inline bool operator < (const Poco::UInt16& other, const Var& da)
	/// Less than operator for comparing Var with include.Poco.Poco.Poco::UInt16
{
	if (da.isEmpty()) return false;
	return other < da.convert<Poco::UInt16>();
}
...
inline bool operator <= (const Poco::UInt16& other, const Var& da)
	/// Less than or equal operator for comparing Var with include.Poco.Poco.Poco::UInt16
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Poco::UInt16>();
}
...
inline bool operator > (const Poco::UInt16& other, const Var& da)
	/// Greater than operator for comparing Var with include.Poco.Poco.Poco::UInt16
{
	if (da.isEmpty()) return false;
	return other > da.convert<Poco::UInt16>();
}
...
inline bool operator >= (const Poco::UInt16& other, const Var& da)
	/// Greater than or equal operator for comparing Var with include.Poco.Poco.Poco::UInt16
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Poco::UInt16>();
}
...
inline Poco::Int32 operator + (const Poco::Int32& other, const Var& da)
	/// Addition operator for adding Var to include.Poco.Poco.Poco::Int32
{
...
inline Poco::Int32 operator - (const Poco::Int32& other, const Var& da)
	/// Subtraction operator for subtracting Var from include.Poco.Poco.Poco::Int32
{
	return other - da.convert<Poco::Int32>();
}
...
inline Poco::Int32 operator * (const Poco::Int32& other, const Var& da)
	/// Multiplication operator for multiplying Var with include.Poco.Poco.Poco::Int32
{
	return other * da.convert<Poco::Int32>();
}
...
inline Poco::Int32 operator / (const Poco::Int32& other, const Var& da)
	/// Division operator for dividing Var with include.Poco.Poco.Poco::Int32
{
	return other / da.convert<Poco::Int32>();
}
...
inline Poco::Int32 operator += (Poco::Int32& other, const Var& da)
	/// Addition assignment operator for adding Var to include.Poco.Poco.Poco::Int32
{
	return other += da.convert<Poco::Int32>();
}
...
inline Poco::Int32 operator -= (Poco::Int32& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from include.Poco.Poco.Poco::Int32
{
	return other -= da.convert<Poco::Int32>();
}
...
inline Poco::Int32 operator *= (Poco::Int32& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with include.Poco.Poco.Poco::Int32
{
	return other *= da.convert<Poco::Int32>();
}
...
inline Poco::Int32 operator /= (Poco::Int32& other, const Var& da)
	/// Division assignment operator for dividing Var with include.Poco.Poco.Poco::Int32
{
	return other /= da.convert<Poco::Int32>();
}
...
inline bool operator == (const Poco::Int32& other, const Var& da)
	/// Equality operator for comparing Var with include.Poco.Poco.Poco::Int32
{
	if (da.isEmpty()) return false;
	return other == da.convert<Poco::Int32>();
}
...
inline bool operator != (const Poco::Int32& other, const Var& da)
	/// Inequality operator for comparing Var with include.Poco.Poco.Poco::Int32
{
	if (da.isEmpty()) return true;
	return other != da.convert<Poco::Int32>();
}
...
inline bool operator < (const Poco::Int32& other, const Var& da)
	/// Less than operator for comparing Var with include.Poco.Poco.Poco::Int32
{
	if (da.isEmpty()) return false;
	return other < da.convert<Poco::Int32>();
}
...
inline bool operator <= (const Poco::Int32& other, const Var& da)
	/// Less than or equal operator for comparing Var with include.Poco.Poco.Poco::Int32
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Poco::Int32>();
}
...
inline bool operator > (const Poco::Int32& other, const Var& da)
	/// Greater than operator for comparing Var with include.Poco.Poco.Poco::Int32
{
	if (da.isEmpty()) return false;
	return other > da.convert<Poco::Int32>();
}
...
inline bool operator >= (const Poco::Int32& other, const Var& da)
	/// Greater than or equal operator for comparing Var with include.Poco.Poco.Poco::Int32
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Poco::Int32>();
}
...
inline Poco::UInt32 operator + (const Poco::UInt32& other, const Var& da)
	/// Addition operator for adding Var to include.Poco.Poco.Poco::UInt32
{
...
inline Poco::UInt32 operator - (const Poco::UInt32& other, const Var& da)
	/// Subtraction operator for subtracting Var from include.Poco.Poco.Poco::UInt32
{
	return other - da.convert<Poco::UInt32>();
}
...
inline Poco::UInt32 operator * (const Poco::UInt32& other, const Var& da)
	/// Multiplication operator for multiplying Var with include.Poco.Poco.Poco::UInt32
{
	return other * da.convert<Poco::UInt32>();
}
...
inline Poco::UInt32 operator / (const Poco::UInt32& other, const Var& da)
	/// Division operator for dividing Var with include.Poco.Poco.Poco::UInt32
{
	return other / da.convert<Poco::UInt32>();
}
...
inline Poco::UInt32 operator += (Poco::UInt32& other, const Var& da)
	/// Addition assignment operator for adding Var to include.Poco.Poco.Poco::UInt32
{
	return other += da.convert<Poco::UInt32>();
}
...
inline Poco::UInt32 operator -= (Poco::UInt32& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from include.Poco.Poco.Poco::UInt32
{
	return other -= da.convert<Poco::UInt32>();
}
...
inline Poco::UInt32 operator *= (Poco::UInt32& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with include.Poco.Poco.Poco::UInt32
{
	return other *= da.convert<Poco::UInt32>();
}
...
inline Poco::UInt32 operator /= (Poco::UInt32& other, const Var& da)
	/// Division assignment operator for dividing Var with include.Poco.Poco.Poco::UInt32
{
	return other /= da.convert<Poco::UInt32>();
}
...
inline bool operator == (const Poco::UInt32& other, const Var& da)
	/// Equality operator for comparing Var with include.Poco.Poco.Poco::UInt32
{
	if (da.isEmpty()) return false;
	return other == da.convert<Poco::UInt32>();
}
...
inline bool operator != (const Poco::UInt32& other, const Var& da)
	/// Inequality operator for comparing Var with include.Poco.Poco.Poco::UInt32
{
	if (da.isEmpty()) return true;
	return other != da.convert<Poco::UInt32>();
}
...
inline bool operator < (const Poco::UInt32& other, const Var& da)
	/// Less than operator for comparing Var with include.Poco.Poco.Poco::UInt32
{
	if (da.isEmpty()) return false;
	return other < da.convert<Poco::UInt32>();
}
...
inline bool operator <= (const Poco::UInt32& other, const Var& da)
	/// Less than or equal operator for comparing Var with include.Poco.Poco.Poco::UInt32
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Poco::UInt32>();
}
...
inline bool operator > (const Poco::UInt32& other, const Var& da)
	/// Greater than operator for comparing Var with include.Poco.Poco.Poco::UInt32
{
	if (da.isEmpty()) return false;
	return other > da.convert<Poco::UInt32>();
}
...
inline bool operator >= (const Poco::UInt32& other, const Var& da)
	/// Greater than or equal operator for comparing Var with include.Poco.Poco.Poco::UInt32
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Poco::UInt32>();
}
...
inline Poco::Int64 operator + (const Poco::Int64& other, const Var& da)
	/// Addition operator for adding Var to include.Poco.Poco.Poco::Int64
{
...
inline Poco::Int64 operator - (const Poco::Int64& other, const Var& da)
	/// Subtraction operator for subtracting Var from include.Poco.Poco.Poco::Int64
{
	return other - da.convert<Poco::Int64>();
}
...
inline Poco::Int64 operator * (const Poco::Int64& other, const Var& da)
	/// Multiplication operator for multiplying Var with include.Poco.Poco.Poco::Int64
{
	return other * da.convert<Poco::Int64>();
}
...
inline Poco::Int64 operator / (const Poco::Int64& other, const Var& da)
	/// Division operator for dividing Var with include.Poco.Poco.Poco::Int64
{
	return other / da.convert<Poco::Int64>();
}
...
inline Poco::Int64 operator += (Poco::Int64& other, const Var& da)
	/// Addition assignment operator for adding Var to include.Poco.Poco.Poco::Int64
{
	return other += da.convert<Poco::Int64>();
}
...
inline Poco::Int64 operator -= (Poco::Int64& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from include.Poco.Poco.Poco::Int64
{
	return other -= da.convert<Poco::Int64>();
}
...
inline Poco::Int64 operator *= (Poco::Int64& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with include.Poco.Poco.Poco::Int64
{
	return other *= da.convert<Poco::Int64>();
}
...
inline Poco::Int64 operator /= (Poco::Int64& other, const Var& da)
	/// Division assignment operator for dividing Var with include.Poco.Poco.Poco::Int64
{
	return other /= da.convert<Poco::Int64>();
}
...
inline bool operator == (const Poco::Int64& other, const Var& da)
	/// Equality operator for comparing Var with include.Poco.Poco.Poco::Int64
{
	if (da.isEmpty()) return false;
	return other == da.convert<Poco::Int64>();
}
...
inline bool operator != (const Poco::Int64& other, const Var& da)
	/// Inequality operator for comparing Var with include.Poco.Poco.Poco::Int64
{
	if (da.isEmpty()) return true;
	return other != da.convert<Poco::Int64>();
}
...
inline bool operator < (const Poco::Int64& other, const Var& da)
	/// Less than operator for comparing Var with include.Poco.Poco.Poco::Int64
{
	if (da.isEmpty()) return false;
	return other < da.convert<Poco::Int64>();
}
...
inline bool operator <= (const Poco::Int64& other, const Var& da)
	/// Less than or equal operator for comparing Var with include.Poco.Poco.Poco::Int64
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Poco::Int64>();
}
...
inline bool operator > (const Poco::Int64& other, const Var& da)
	/// Greater than operator for comparing Var with include.Poco.Poco.Poco::Int64
{
	if (da.isEmpty()) return false;
	return other > da.convert<Poco::Int64>();
}
...
inline bool operator >= (const Poco::Int64& other, const Var& da)
	/// Greater than or equal operator for comparing Var with include.Poco.Poco.Poco::Int64
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Poco::Int64>();
}
...
inline Poco::UInt64 operator + (const Poco::UInt64& other, const Var& da)
	/// Addition operator for adding Var to include.Poco.Poco.Poco::UInt64
{
...
inline Poco::UInt64 operator - (const Poco::UInt64& other, const Var& da)
	/// Subtraction operator for subtracting Var from include.Poco.Poco.Poco::UInt64
{
	return other - da.convert<Poco::UInt64>();
}
...
inline Poco::UInt64 operator * (const Poco::UInt64& other, const Var& da)
	/// Multiplication operator for multiplying Var with include.Poco.Poco.Poco::UInt64
{
	return other * da.convert<Poco::UInt64>();
}
...
inline Poco::UInt64 operator / (const Poco::UInt64& other, const Var& da)
	/// Division operator for dividing Var with include.Poco.Poco.Poco::UInt64
{
	return other / da.convert<Poco::UInt64>();
}
...
inline Poco::UInt64 operator += (Poco::UInt64& other, const Var& da)
	/// Addition assignment operator for adding Var to include.Poco.Poco.Poco::UInt64
{
	return other += da.convert<Poco::UInt64>();
}
...
inline Poco::UInt64 operator -= (Poco::UInt64& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from include.Poco.Poco.Poco::UInt64
{
	return other -= da.convert<Poco::UInt64>();
}
...
inline Poco::UInt64 operator *= (Poco::UInt64& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with include.Poco.Poco.Poco::UInt64
{
	return other *= da.convert<Poco::UInt64>();
}
...
inline Poco::UInt64 operator /= (Poco::UInt64& other, const Var& da)
	/// Division assignment operator for dividing Var with include.Poco.Poco.Poco::UInt64
{
	return other /= da.convert<Poco::UInt64>();
}
...
inline bool operator == (const Poco::UInt64& other, const Var& da)
	/// Equality operator for comparing Var with include.Poco.Poco.Poco::UInt64
{
	if (da.isEmpty()) return false;
	return other == da.convert<Poco::UInt64>();
}
...
inline bool operator != (const Poco::UInt64& other, const Var& da)
	/// Inequality operator for comparing Var with include.Poco.Poco.Poco::UInt64
{
	if (da.isEmpty()) return true;
	return other != da.convert<Poco::UInt64>();
}
...
inline bool operator < (const Poco::UInt64& other, const Var& da)
	/// Less than operator for comparing Var with include.Poco.Poco.Poco::UInt64
{
	if (da.isEmpty()) return false;
	return other < da.convert<Poco::UInt64>();
}
...
inline bool operator <= (const Poco::UInt64& other, const Var& da)
	/// Less than or equal operator for comparing Var with include.Poco.Poco.Poco::UInt64
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Poco::UInt64>();
}
...
inline bool operator > (const Poco::UInt64& other, const Var& da)
	/// Greater than operator for comparing Var with include.Poco.Poco.Poco::UInt64
{
	if (da.isEmpty()) return false;
	return other > da.convert<Poco::UInt64>();
}
...
inline bool operator >= (const Poco::UInt64& other, const Var& da)
	/// Greater than or equal operator for comparing Var with include.Poco.Poco.Poco::UInt64
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Poco::UInt64>();
}
...
} // namespace include.Poco.Poco.Poco
