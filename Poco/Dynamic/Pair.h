...
public:
	...
	{
		throw BadCastException("Pair -> include.Poco.Poco.Poco::DateTime");
	}

	void convert(Poco::LocalDateTime&) const
	{
		throw BadCastException("Pair -> include.Poco.Poco.Poco::LocalDateTime");
	}

	void convert(Poco::Timestamp&) const
	{
		throw BadCastException("Pair -> include.Poco.Poco.Poco::Timestamp");
	}
