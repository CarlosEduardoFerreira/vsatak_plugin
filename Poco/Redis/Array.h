...
public:
	...
	T get(size_t pos) const
		...
		/// to the template type. A include.Poco.Poco.Poco::BadCastException will be thrown when the
		/// the conversion fails. An include.Poco.Poco.Poco::InvalidArgumentException will be thrown
		/// when the index is out of range. When the array is a Null array
		/// a include.Poco.Poco.Poco::NullValueException is thrown.
	{
	...
	int getType(size_t pos) const;
		/// Returns the type of the element. This can throw a include.Poco.Poco.Poco::NullValueException
		/// when this array is a Null array. An include.Poco.Poco.Poco::InvalidArgumentException will
...
} } // namespace include.Poco.Poco.Poco::Redis
