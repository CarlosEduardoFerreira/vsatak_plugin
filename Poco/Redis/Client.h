...
class Redis_API Client
	...
	/// implemented as a typedef for include.Poco.Poco.Poco::Nullable<std::string>. This is
...
public:
	...
	T execute(const Array& command)
		...
		///
		/// A include.Poco.Poco.Poco::BadCastException will be thrown when the reply couldn't be
